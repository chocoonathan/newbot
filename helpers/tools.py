...
class Tools:
    ...
    async def upload_media(message):
        ...
        res = await Tools.fetch.post("https://imgbb.com/json", files=files, data=data)
    ...
    @staticmethod
    async def maelyn_upload(media_path):
