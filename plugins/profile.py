...
@CMD.UBOT("setname", fakedevcmd=True)
async def _(client, message):
    return await setname_cmd(client, message)


@CMD.UBOT("setuname", fakedevcmd=True)
async def _(client, message):
    return await setuname_cmd(client, message)


@CMD.UBOT("remuname", fakedevcmd=True)
async def _(client, message):
    return await remuname_cmd(client, message)


@CMD.UBOT("setbio", fakedevcmd=True)
async def _(client, message):
...
@CMD.UBOT("setpp", fakedevcmd=True)
async def _(client, message):
