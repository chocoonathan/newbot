...
from command import (acc_page, an1cb, back_home, bola_date, bola_matches,
                     ...
                     gpt_voice, hyt_download, kurang_tambah, mari_buat_userbot,
                     moddycb, news_, next_font, nxt_spotify, nxt_ytsearch,
                     nxtbmkg, page_acc, pm_warn, prev_font, prevnext_userbot,
...
async def _(client, callback):
    try:
        ...
        elif query.startswith("yt_"):
            return await hyt_download(client, callback)
    except Exception:
